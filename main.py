...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_cpus', type=int, default=16, help='cpus available')
    parser.add_argument('--num_actors', type=int, default=None,
                        help='Number of self-play actors (default: num_cpus // 3)')
    ...
    parser.add_argument('--supcon_coeff', type=float, default=None,
                        help='SupCon loss coefficient (0=disabled, e.g. 0.5 or 1.0 to enable)')
    parser.add_argument('--supcon_num_bins', type=int, default=None, help='Number of value bins for SupCon')
    parser.add_argument('--supcon_min_bin_size', type=int, default=None, help='Min samples per bin for SupCon')
    parser.add_argument('--supcon_warmup_fraction', type=float, default=None,
                        help='Fraction of training over which SupCon ramps up (default: 0.5)')
    ...
    parser.add_argument('--object_store_memory', type=int, default=None, help='object store memory in bytes (default: auto)')
    ...
    if args.opr == 'train':
        ray_kwargs = dict(num_gpus=args.num_gpus, num_cpus=args.num_cpus)
